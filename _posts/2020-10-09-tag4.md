...
![Übung und Vergleich von Archivkataloge](https://github.com/sakura-72/my-bain-blog/blob/master/images/einstein_uebung.png)
...
### Funktionen
Anhand der Nutzung der [NYU](https://guides.nyu.edu/ld.php?content_id=23461999) und des Artikel «What ASpace does and how we use it» können folgende Nutzungmöglichkeiten zitiert werden:
* ArchivesSpace als einen System für die Erschliessung von Archivalien. Interessant dabei ist, dass nicht alles öffentlich ist und nicht alles für Mitarbeiter verfügbar ist.
* Zentrale archivarische Funktionen: Zugriff, Ordnung und Beschreibung
* Hilfestellung bei der Nutzung
* Information zum Standort der Archivalien und Management des Platzes
* Digitale Objekte verwalten
* Tools für die Veröffentlichung
* Statistiken für die Priorisierung und Planung
* und noch für weitere Departement übergreiffende Aufgaben
...
* Weitere Optionen: Siehe technische Dokumentation 
...
**Erkenntnisse:**
Wir haben versucht ein Bestand aus dem Staatsarchiv Basel-Stadt zu übernehemen. Es war nicht sehr einfach zu verstehen, welches Teil im Archiv zu welchem Abschnitt in AS gehört. Ob wir richtig übernommen haben, wissen wir nicht.
